...
//    testdoub=&val;
  ...
  */
  ...
  cout<<"4 - XOR"<<endl;
  cout<<"5 - Snake solver"<<endl;
  cout<<"6 - Snake_tester"<<endl;
  cout<<"Number: ";
  ...
  switch ( choice )
    ...
    case 4:
      ...
      break;
    case 5:
      cout<<"Enter gene id: "<<endl;
      cin>> id;
      cout<<"Enter gen file name:"<<endl;
      cin>> filename;
      cout<<"Enter temp name:"<<endl;
      cin >> temp_name;
      p=snake_test(200, id, filename, temp_name);
      break;
    case 6:
      cout<<"Enter gene id: "<<endl;
      cin>> id;
      cout<<"Enter gen file name"<<endl;
      cin>> filename;
      snake_test_routine(id, filename);
      break;
    default:
